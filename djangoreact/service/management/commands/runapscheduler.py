...
def my_job():
    ...
    # 현재 날짜에서 -100day한 것보다 created_at날짜가 적으면 삭제 
    OTTservice.objects.filter(created_at__lte=datetime.now()-timedelta(months=4)).delete() 
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        scheduler.add_job(
            my_job,
            trigger=CronTrigger(hour="00", minute="00"),  # Everyday midnight
