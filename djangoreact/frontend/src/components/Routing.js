      ...
      <BrowserRouter>
           ...
           <NavBar />
                  <Routes>
                    ...
                    <Route path="/ott_recommended" element={<PrivateRoute><OttTest /></PrivateRoute>} />  {/* 제한 Private */}


                    {/* 결과 */}
                    <Route path="/movie_result" element={<PrivateRoute><ContentsResult /></PrivateRoute>} /> {/* 제한 Private */}
